...
getDealsApproved = () => {
    ...
    this.services.getDealsApproved()
...
<>
 ...
 <ul class="list-group">
  ...
  {this.props.loggedInUser && <Link to="#" onClick={this.openModal}>Crear nuevo chollo</Link>}
  </li>
  <li className="list-group-item d-flex justify-content-between align-items-center">
    {this.props.loggedInUser && <Link to="#" onClick={this.getDealsApproved}>Ver chollos publicados</Link>}
    <span className="badge badge-primary badge-pill">{this.state.deals.length}</span>
  </li>
  <li className="list-group-item d-flex justify-content-between align-items-center">
    
  {this.props.loggedInUser && <Link to="#" onClick={this.getDealsPending}>Ver chollos pendientes de aprobacion</Link>}
